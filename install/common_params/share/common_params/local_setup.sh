...
: ${AMENT_CURRENT_PREFIX:="/media/ezzedinayman/Local Disk/FS-System/fs-system/install/common_params"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/common_params/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/common_params/environment/path.sh"

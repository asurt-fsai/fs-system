#include "../include/scanmatcher/scanmatcher_component.h"
...
namespace graphslam
{
  ...
  /* Summary:
   * Initializes publishers and subscribers for the ScanMatcherComponent.
   *
   * Extended description:
   * This function initializes the necessary publishers and subscribers for the
   * ScanMatcherComponent. It sets up subscribers for the initial pose, IMU data,
   * and input point cloud. Additionally, it creates publishers for the current
   * pose, the map, the map array, and the path.
   *
   * Parameters:
   * None.
   *
  ...
  /* Summary:
   * Initializes the map with the first received point cloud.
   *
   * Extended description:
   * This function creates the initial map using the first received point cloud.
   * It applies voxel grid filtering to downsample the point cloud, transforms it
   * according to the initial pose, and sets it as the input target for the
   * registration process. Additionally, it generates a sensor_msgs::PointCloud2
   * message for the map and adds it to the lidarslam_msgs::msg::MapArray.
   *
   * Parameters:
   * - tmp_ptr: A pointer to the first received point cloud.
   * - header: The header of the first received point cloud message.
   *
   * Returns:
   * None.
   */
